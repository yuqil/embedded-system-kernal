...
KOBJS := assert.o main.o math.o memcheck.o raise.o ctype.o hexdump.o device.o recover.o my_swi_handler.o wireHandler.o ld_usr_pro.o init_irq.o init_timer.o c_irq_handler.o c_swi_handler.o my_read.o my_write.o my_irq_handler.o
KOBJS := $(KOBJS:%=$(KDIR)/%)
